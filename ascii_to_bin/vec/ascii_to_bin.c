 ...
 *  This code works for scalar doubles only. 
 *  If complex numbered vectors are to be used, the loop end 
 *  criterion has to be changed since complex numbers are stored
